def basic_strategy_s17(hand, dealer_upcard, split_allowed, surrender_allowed, true_count=0):
    if hand.value() == 21: 
        return "stand"
    ...
    if surrender_allowed and len(hand.cards) == 2 and not hand.is_soft():
        if total == 16 and not hand.is_pair() and up in [9, 10, 11]:
            return "surrender"
        elif total == 15 and up == 10:
            return "surrender"
...
def basic_strategy_h17(hand, dealer_upcard, split_allowed, surrender_allowed, true_count=0):
    if hand.value() == 21: 
        return "stand"
    ...
    if surrender_allowed and len(hand.cards) == 2 and not hand.is_soft():
        if total == 17 and up == 11:
            return "surrender"
        elif total == 16 and up in [9, 10, 11]:
            return "surrender"
